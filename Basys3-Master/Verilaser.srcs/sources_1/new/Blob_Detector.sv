...
module Blob_Detector (
    ...
    input  logic       vsync,
    output logic [9:0] center_x_r,
    output logic [9:0] center_y_r,
    output logic [9:0] center_x_g,
    output logic [9:0] center_y_g,
    output logic [9:0] center_x_b,
    output logic [9:0] center_y_b,
