    ...
    always_ff @(posedge pclk or posedge reset) begin
        if (reset) begin
            ...
            if (vsync) begin
                ...
                sum_x_r <= 0; sum_y_r <= 0; pixel_counter_r <= 0;
                sum_x_g <= 0; sum_y_g <= 0; pixel_counter_g <= 0;
                sum_x_b <= 0; sum_y_b <= 0; pixel_counter_b <= 0;
            end else begin
                if (mask_red) begin
